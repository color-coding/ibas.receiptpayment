...
public class AssetRecharge extends BusinessObject<AssetRecharge>
	 ...
	 * 业务伙伴资产码 属性
	 */
	@DbField(name = "ServiceCode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 汇率 属性
	 */
	@DbField(name = "Rate", type = DataType.DECIMAL, editType = EditType.RATE, table = DB_TABLE_NAME)
		...
		if (this.getBusinessPartnerType() == emBusinessPartnerType.CUSTOMER) {
			contracts.add(new ICustomerCheckContract() {
				...
				public String getCustomerName() {
					return AssetRecharge.this.getBusinessPartnerName();
				}

				@Override
				public void setCustomerName(String value) {
					AssetRecharge.this.setBusinessPartnerName(value);
				}
			});
