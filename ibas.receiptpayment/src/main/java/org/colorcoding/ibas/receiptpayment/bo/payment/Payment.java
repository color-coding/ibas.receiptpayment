...
public class Payment extends BusinessObject<Payment>
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 6575783952004759935L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Payment.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_RP_OPAY";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Payment";
	 ...
	 * 期间 属性
	 */
	@DbField(name = "Period", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 单据状态 属性
	 */
	@DbField(name = "DocStatus", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 过账日期 属性
	 */
	@DbField(name = "DocDate", type = DataType.DATE, table = DB_TABLE_NAME)
	 ...
	 * 到期日 属性
	 */
	@DbField(name = "DocDueDate", type = DataType.DATE, table = DB_TABLE_NAME)
	 ...
	 * 凭证日期 属性
	 */
	@DbField(name = "TaxDate", type = DataType.DATE, table = DB_TABLE_NAME)
	 ...
	 * 业务伙伴名称 属性
	 */
	@DbField(name = "CardName", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 联系人 属性
	 */
	@DbField(name = "CntctCode", type = DataType.NUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 单据货币 属性
	 */
	@DbField(name = "DocCur", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 单据汇率 属性
	 */
	@DbField(name = "DocRate", type = DataType.DECIMAL, editType = EditType.RATE, table = DB_TABLE_NAME)
	 ...
	 * 单据总计 属性
	 */
	@DbField(name = "DocTotal", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 单据类型 属性
	 */
	@DbField(name = "OrderType", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 预付款 属性
	 */
	@DbField(name = "DownPayment", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 已清金额 属性
	 */
	@DbField(name = "ClosedAmt", type = DataType.DECIMAL, editType = EditType.SUM, table = DB_TABLE_NAME)
	 ...
	 * 分录合并方式 属性
	 */
	@DbField(name = "MergMethod", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 
	 */
	public static final IPropertyInfo<IPaymentItems> PROPERTY_PAYMENTITEMS = registerProperty(
			PROPERTY_PAYMENTITEMS_NAME, IPaymentItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_PAYMENTITEMS_NAME)
	@XmlElement(name = PaymentItem.BUSINESS_OBJECT_NAME, type = PaymentItem.class)
	public final IPaymentItems getPaymentItems() {
		return this.getProperty(PROPERTY_PAYMENTITEMS);
	}
	 ...
	 * @param value 值
	 */
	public final void setPaymentItems(IPaymentItems value) {
		this.setProperty(PROPERTY_PAYMENTITEMS, value);
	}
	...
	protected void initialize() {
		...
		this.setPaymentItems(new PaymentItems(this));
	...
	protected IBusinessRule[] registerRules() {
		return new IBusinessRule[] { // 注册的业务规则
				...
				// new BusinessRuleMinValue<BigDecimal>(Decimals.ZERO, PROPERTY_DOCUMENTTOTAL),//
				// 不能低于0
	...
	public IBusinessLogicContract[] getContracts() {
		...
		if (this.getBusinessPartnerType() == emBusinessPartnerType.CUSTOMER) {
			contracts.add(new ICustomerCheckContract() {
				...
				public String getCustomerName() {
					return Payment.this.getBusinessPartnerName();
				}

				@Override
				public void setCustomerName(String value) {
					Payment.this.setBusinessPartnerName(value);
				}
			});
		...
		contracts.add(new IJournalEntryCreationContract() {
			...
			public String getMergingMethod() {
				return Payment.this.getMergingMethod();
			}
