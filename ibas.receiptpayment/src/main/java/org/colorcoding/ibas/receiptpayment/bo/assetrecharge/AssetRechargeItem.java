...
public class AssetRechargeItem extends BusinessObject<AssetRechargeItem> implements IAssetRechargeItem,
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 7886962963917488284L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = AssetRechargeItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_RP_ARC1";
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "AssetRechargeItem";
	 ...
	 * 方式 属性
	 */
	@DbField(name = "Mode", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
	 ...
	 * 交易识别码 属性
	 */
	@DbField(name = "TradeId", type = DataType.ALPHANUMERIC, table = DB_TABLE_NAME)
		...
		if (IBusinessPartnerAssetIncreasesContract.ASSET_MODE_SIGN.equals(this.getMode())) {
			contracts.add(new IBusinessPartnerAssetConsumptionContract() {
				...
				public String getIdentifiers() {
					return AssetRechargeItem.this.getIdentifiers();
				}

				@Override
				public String getServiceCode() {
					return AssetRechargeItem.this.getTradeId();
				}
				...
				public String getCurrency() {
					return AssetRechargeItem.this.getCurrency();
				}

				@Override
				public String getBaseDocumentType() {
					return AssetRechargeItem.this.getObjectCode();
				}

				@Override
				public Integer getBaseDocumentEntry() {
					return AssetRechargeItem.this.getDocEntry();
				}

				@Override
				public Integer getBaseDocumentLineId() {
					return AssetRechargeItem.this.getLineId();
				}
