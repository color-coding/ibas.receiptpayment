...
namespace receiptpayment {
    export namespace ui {
        export namespace m {
            /** 选择视图-收款单 */
            export class ReceiptChooseView extends ibas.BOChooseView implements app.IReceiptChooseView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.Receipt;
                }
                                ...
                                attributes: [
                                        ...
                                        title: {
                                            ...
                                            formatter(data: businesspartner.bo.emBusinessPartnerType): string {
                                                return data === businesspartner.bo.emBusinessPartnerType.SUPPLIER
                                                    ? ibas.i18n.prop("bo_receipt_suppliercode")
                                                    : ibas.i18n.prop("bo_receipt_customercode");
                                            }
                                        },
                                        bindingValue: {
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: {
                                            ...
                                            formatter(data: businesspartner.bo.emBusinessPartnerType): string {
                                                return data === businesspartner.bo.emBusinessPartnerType.SUPPLIER
                                                    ? ibas.i18n.prop("bo_receipt_suppliername")
                                                    : ibas.i18n.prop("bo_receipt_customername");
                                            }
                                        },
                                        bindingValue: {
