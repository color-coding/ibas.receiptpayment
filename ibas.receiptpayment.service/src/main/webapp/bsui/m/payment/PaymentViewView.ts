    ...
    export namespace ui {
        export namespace m {
            ...
            export class PaymentViewView extends ibas.BOViewView implements app.IPaymentViewView {
                                                        ...
                                                        parts: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                formatter(data: ibas.emYesNo): string {
                                                                    return ibas.emYesNo.YES === data ? ibas.i18n.prop("bo_payment_canceled") : "";
                                                                },
                                                            },
                                                        ]
                                                    }),
                                                ...
                                                items: {
                                                    ...
                                                    template: new sap.m.ObjectListItem("", {
                                                        ...
                                                        press: function (oEvent: sap.ui.base.Event): void {
                                                            that.viewPaymentItem(this.getBindingContext().getObject());
                                                        },
                                                    })
                                                }
                                            }).addStyleClass("sapUxAPObjectPageSubSectionAlignContent"),
                ...
                /** 编辑数据行（付款单-行） */
                viewPaymentItem(data: bo.PaymentItem): void {
                    let that: this = this;
                    let editForm: sap.m.Dialog = new sap.m.Dialog("", {
                        title: {
                            ...
                            type: new sap.extension.data.Numeric(),
                            formatter(data: string): string {
                                return ibas.strings.format("{0} - {1}", ibas.i18n.prop("bo_paymentitem"), data);
                            }
                        },
                        ...
                        content: [
                            new sap.extension.layout.DataSimpleForm("", {
                                ...
                                content: [
                                    ...
                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_paymentitem_itemcode") }),
                                    new sap.extension.m.Text("", {
                                    }).bindProperty("bindingValue", {
                                        path: "itemCode",
                                        type: new sap.extension.data.Alphanumeric(),
                                    }),
                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_paymentitem_itemdescription") }),
                                    new sap.extension.m.Text("", {
                                    }).bindProperty("bindingValue", {
                                        path: "itemDescription",
                                        type: new sap.extension.data.Alphanumeric()
                                    }),
                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_paymentitem_warehouse") }),
                                    new sap.extension.m.RepositoryText("", {
                                    ...
                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_paymentitem_quantity") }),
                                    new sap.extension.m.Text("", {
                                    }).bindProperty("bindingValue", {
                                        parts: [
                                            {
                                    ...
                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_paymentitem_price") }),
                                    new sap.extension.m.Text("", {
                                    }).bindProperty("bindingValue", {
                                        parts: [
                                            {
                                    ...
                                    new sap.m.Label("", { text: ibas.i18n.prop("bo_paymentitem_linetotal") }),
                                    new sap.extension.m.Text("", {
                                    }).bindProperty("bindingValue", {
                                        parts: [
                                            {
