                                ...
                                attributes: [
                                        ...
                                        title: {
                                            ...
                                            formatter(data: businesspartner.bo.emBusinessPartnerType): string {
                                                return data === businesspartner.bo.emBusinessPartnerType.SUPPLIER
                                                    ? ibas.i18n.prop("bo_payment_suppliercode")
                                                    : ibas.i18n.prop("bo_payment_customercode");
                                            }
                                        },
                                        bindingValue: {
                                    ...
                                    new sap.extension.m.ObjectAttribute("", {
                                        title: {
                                            ...
                                            formatter(data: businesspartner.bo.emBusinessPartnerType): string {
                                                return data === businesspartner.bo.emBusinessPartnerType.SUPPLIER
                                                    ? ibas.i18n.prop("bo_payment_suppliername")
                                                    : ibas.i18n.prop("bo_payment_customername");
                                            }
                                        },
                                        bindingValue: {
