...
namespace receiptpayment {
    export namespace ui {
        export namespace c {
             ...
             * 列表视图-收款
             */
            export class ReceiptListView extends ibas.BOListView implements app.IReceiptListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.Receipt;
                }
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_receipt_canceled"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "canceled",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_receipt_printed"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "printed",
                                    type: new sap.extension.data.YesNo(true)
                            ...
                            new sap.extension.table.DataColumn("", {
                                ...
                                template: new sap.extension.m.Link("", {
                                    press(): void {
                                        ...
                                        if (data instanceof bo.Receipt && !ibas.strings.isEmpty(data.businessPartnerCode)) {
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_receipt_dataowner"),
                            ...
                            content: [
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (event: sap.ui.base.Event): void {
                                        ...
                                        for (let item of that.table.getSelecteds<bo.Receipt>()) {
                                            criteria.result++;
