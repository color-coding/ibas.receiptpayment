...
namespace receiptpayment {
    export namespace ui {
        export namespace c {
             ...
             * 列表视图-付款
             */
            export class PaymentListView extends ibas.BOListView implements app.IPaymentListView {
                /** 返回查询的对象 */
                get queryTarget(): any {
                    return bo.Payment;
                }
                ...
                draw(): any {
                    ...
                    this.table = new sap.extension.table.DataTable("", {
                        ...
                        columns: [
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_payment_canceled"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "canceled",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_payment_printed"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "printed",
                                    type: new sap.extension.data.YesNo(true)
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_payment_businesspartnertype"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                            ...
                            new sap.extension.table.DataColumn("", {
                                ...
                                template: new sap.extension.m.Link("", {
                                    press(): void {
                                        ...
                                        if (data instanceof bo.Payment && !ibas.strings.isEmpty(data.businessPartnerCode)) {
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_payment_documentdate"),
                                template: new sap.extension.m.Text("", {
                                }).bindProperty("bindingValue", {
                                    path: "documentDate",
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_payment_ordertype"),
                            ...
                            new sap.extension.table.DataColumn("", {
                                label: ibas.i18n.prop("bo_payment_dataowner"),
                            ...
                            content: [
                                ...
                                new sap.m.Button("", {
                                    ...
                                    press: function (event: sap.ui.base.Event): void {
                                        ...
                                        for (let item of that.table.getSelecteds<bo.Payment>()) {
                                            criteria.result++;
