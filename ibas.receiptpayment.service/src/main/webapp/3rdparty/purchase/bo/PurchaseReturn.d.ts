...
/** 采购退货-行 集合 */
export interface IPurchaseReturnItems extends IBusinessObjects<IPurchaseReturnItem, IPurchaseReturn> {
...
/** 采购退货-行 */
export interface IPurchaseReturnItem extends IBODocumentLine, IMaterialBatchItemParent, IMaterialSerialItemParent {
