...
declare namespace sales {
    ...
    namespace bo {
        ...
        /** 业务对象编码-销售退货请求 */
        const BO_CODE_SALESRETURNREQUEST: string;
        /** 运输状态 */
...
declare namespace sales {
    namespace bo {
        /** 销售退货请求 */
        interface ISalesReturnRequest extends ibas.IBODocument, ibas.IBOUserFields {
            /** 凭证编号 */
            docEntry: number;
            /** 单据编码 */
            docNum: string;
        ...
        /** 销售退货请求-行 集合 */
        interface ISalesReturnRequestItems extends ibas.IBusinessObjects<ISalesReturnRequestItem> {
            /** 创建并添加子项 */
            create(): ISalesReturnRequestItem;
        }
        /** 销售退货请求-行 */
        interface ISalesReturnRequestItem extends ibas.IBODocumentLine, materials.bo.IMaterialBatchItemParent, materials.bo.IMaterialSerialItemParent, ibas.IBOUserFields {
            /** 编码 */
            docEntry: number;
            /** 行号 */
            lineId: number;
...
declare namespace sales {
    namespace bo {
        ...
        class SalesDelivery extends ibas.BODocument<SalesDelivery> implements ISalesDelivery, ibas.IConvertedData {
            ...
            /** 映射的属性名称-毛利价格清单 */
            static PROPERTY_GROSSBASE_NAME: string;
            /** 获取-毛利价格清单 */
...
declare namespace sales {
    namespace bo {
        /** 销售退货请求 */
        class SalesReturnRequest extends ibas.BODocument<SalesReturnRequest> implements ISalesReturnRequest, ibas.IConvertedData {
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string;
            /** 构造函数 */
            constructor();
            ...
            /** 获取-销售退货请求-行集合 */
            get salesReturnRequestItems(): SalesReturnRequestItems;
            /** 设置-销售退货请求-行集合 */
            set salesReturnRequestItems(value: SalesReturnRequestItems);
            /** 映射的属性名称-送货地址集合 */
            static PROPERTY_SHIPPINGADDRESSS_NAME: string;
            /** 获取-送货地址集合 */
            get shippingAddresss(): ShippingAddresss;
        ...
        class SalesReturnRequestItems extends ibas.BusinessObjects<SalesReturnRequestItem, SalesReturnRequest> implements ISalesReturnRequestItems {
            /** 创建并添加子项 */
            create(): SalesReturnRequestItem;
            /** 移出项目之后 */
            protected afterRemove(item: SalesReturnRequestItem): void;
            /** 子项属性改变时 */
            protected onItemPropertyChanged(item: SalesReturnRequestItem, name: string): void;
            protected afterAdd(item: SalesReturnRequestItem): void;
            protected onParentPropertyChanged(name: string): void;
        }
        /** 销售退货请求-行 */
        class SalesReturnRequestItem extends ibas.BODocumentLine<SalesReturnRequestItem> implements ISalesReturnRequestItem {
            /** 构造函数 */
            constructor();
            /** 映射的属性名称-编码 */
            static PROPERTY_DOCENTRY_NAME: string;
...
declare namespace sales {
    namespace bo {
         ...
         * @param source 源
         */
        function baseDocument(target: SalesOrder | SalesDelivery | SalesReturn | SalesCreditNote | SalesInvoice | DownPaymentRequest | SalesReserveInvoice | SalesReturnRequest, source: ISalesQuote | ISalesOrder | ISalesDelivery | ISalesReturn | ISalesInvoice | ISalesReserveInvoice | SalesReturnRequest): void;
        /**
         * 基于单据
         * @param target 目标
         * @param source 源
...
declare namespace sales {
    namespace app {
        ...
        /** 销售订单目标服务（成品关联占用） */
        class MaterialOrderedReservationTargetSalesOrderFinishedProductService extends ibas.ServiceApplication<ibas.IView, materials.app.IMaterialOrderedReservationTarget> {
            /** 应用标识 */
            static APPLICATION_ID: string;
            /** 应用名称 */
            static APPLICATION_NAME: string;
        ...
        class MaterialOrderedReservationTargetSalesOrderFinishedProductServiceMapping extends ibas.ServiceMapping {
            /** 构造函数 */
            constructor();
            /** 创建服务实例 */
            create(): ibas.IService<ibas.IServiceContract>;
...
declare namespace sales {
    namespace app {
        ...
        interface ISalesCreditNoteEditView extends ibas.IBOEditView {
            ...
            /** 选择一业务伙伴目录事件 */
            chooseSalesCreditNoteItemMaterialCatalogEvent: Function;
            /** 选择销售贷项-销售退货事件 */
...
declare namespace sales {
    namespace app {
        ...
        interface ISalesReserveInvoiceEditView extends ibas.IBOEditView {
            ...
            /** 选择一业务伙伴目录事件 */
            chooseSalesReserveInvoiceItemMaterialCatalogEvent: Function;
            /** 选择销售预留发票-销售订单事件 */
...
declare namespace sales {
    namespace app {
        /** 选择应用-销售退货请求 */
        class SalesReturnRequestChooseApp extends ibas.BOChooseService<ISalesReturnRequestChooseView, bo.SalesReturnRequest> {
            /** 应用标识 */
            static APPLICATION_ID: string;
            /** 应用名称 */
            static APPLICATION_NAME: string;
        ...
        /** 视图-销售退货请求 */
        interface ISalesReturnRequestChooseView extends ibas.IBOChooseView {
            /** 显示数据 */
            showData(datas: bo.SalesReturnRequest[]): void;
        }
        /** 销售退货请求选择服务映射 */
        class SalesReturnRequestChooseServiceMapping extends ibas.BOChooseServiceMapping {
            /** 构造函数 */
            constructor();
            /** 创建服务实例 */
...
declare namespace sales {
    namespace app {
        /** 编辑应用-销售退货请求 */
        class SalesReturnRequestEditApp extends ibas.BOEditService<ISalesReturnRequestEditView, bo.SalesReturnRequest> {
            /** 应用标识 */
            static APPLICATION_ID: string;
            /** 应用名称 */
            static APPLICATION_NAME: string;
            ...
            private customer;
            /** 选择销售退货请求客户事件 */
            private chooseSalesReturnRequestCustomer;
            /** 选择销售退货请求价格清单事件 */
            private chooseSalesReturnRequestPriceList;
            /** 更改行价格 */
            private changeSalesReturnRequestItemPrice;
            /** 选择销售退货请求物料事件 */
            private chooseSalesReturnRequestItemMaterial;
            private chooseSalesReturnRequestItemWarehouse;
            /** 添加销售退货请求-行事件 */
            private addSalesReturnRequestItem;
            /** 删除销售退货请求-行事件 */
            private removeSalesReturnRequestItem;
            private batches;
            /** 选择物料批次信息 */
            private createSalesReturnRequestLineMaterialBatch;
            private serials;
            /** 选择物料序列信息 */
            ...
            /** 转为销售贷项事件 */
            protected turnToSalesReturn(): void;
            private chooseSalesReturnRequestItemUnit;
        ...
        /** 销售退货请求编辑服务映射 */
        class SalesReturnRequestEditServiceMapping extends ibas.BOEditServiceMapping {
            /** 构造函数 */
            constructor();
            /** 创建服务实例 */
...
declare namespace sales {
    namespace app {
        class SalesReturnRequestFunc extends ibas.ModuleFunction {
            /** 功能标识 */
            static FUNCTION_ID: string;
            /** 功能名称 */
            static FUNCTION_NAME: string;
...
declare namespace sales {
    namespace app {
        /** 列表应用-销售退货请求 */
        class SalesReturnRequestListApp extends ibas.BOListApplication<ISalesReturnRequestListView, bo.SalesReturnRequest> {
            /** 应用标识 */
            static APPLICATION_ID: string;
            /** 应用名称 */
            static APPLICATION_NAME: string;
        ...
        /** 视图-销售退货请求 */
        interface ISalesReturnRequestListView extends ibas.IBOListView {
            /** 编辑数据事件，参数：编辑对象 */
            editDataEvent: Function;
            /** 删除数据事件，参数：删除对象集合 */
            deleteDataEvent: Function;
...
declare namespace sales {
    namespace app {
        /** 查看应用-销售退货请求 */
        class SalesReturnRequestViewApp extends ibas.BOViewService<ISalesReturnRequestViewView, bo.SalesReturnRequest> {
            /** 应用标识 */
            static APPLICATION_ID: string;
            /** 应用名称 */
            static APPLICATION_NAME: string;
        ...
        /** 销售退货请求连接服务映射 */
        class SalesReturnRequestLinkServiceMapping extends ibas.BOLinkServiceMapping {
            /** 构造函数 */
            constructor();
            /** 创建服务实例 */
            create(): ibas.IService<ibas.IBOLinkServiceCaller>;
