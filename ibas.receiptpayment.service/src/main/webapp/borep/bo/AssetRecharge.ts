...
namespace receiptpayment {
    export namespace bo {
        ...
        export class AssetRecharge extends ibas.BODocument<AssetRecharge> implements IAssetRecharge {
            ...
            /** 获取-单据编码 */
            get docNum(): string {
                return this.getProperty<string>(AssetRecharge.PROPERTY_DOCNUM_NAME);
            }
            /** 设置-单据编码 */
            ...
            get printed(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(AssetRecharge.PROPERTY_PRINTED_NAME);
            }
            /** 设置-已打印 */
            set printed(value: ibas.emYesNo) {
                this.setProperty(AssetRecharge.PROPERTY_PRINTED_NAME, value);
            }
        ...
        export class AssetRechargeItem extends ibas.BODocumentLine<AssetRechargeItem> implements IAssetRechargeItem {
            ...
            /** 获取-现金流项目 */
            get cashFlow(): number {
                return this.getProperty<number>(AssetRechargeItem.PROPERTY_CASHFLOW_NAME);
            }
            /** 设置-现金流项目 */
            set cashFlow(value: number) {
                this.setProperty(AssetRechargeItem.PROPERTY_CASHFLOW_NAME, value);
            }
