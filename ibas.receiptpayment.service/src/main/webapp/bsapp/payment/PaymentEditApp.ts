...
namespace receiptpayment {
    export namespace app {
        ...
        export class PaymentEditApp extends ibas.BOEditService<IPaymentEditView, bo.Payment> {
            ...
            /** 选择付款客户事件 */
            private choosePaymentBusinessPartner(filterConditions?: ibas.ICondition[]): void {
            ...
            private choosePaymentItemModeTradeId(data: bo.PaymentItem): void {
                ...
                if (ibas.strings.isEmpty(data.mode)) {
                    this.messages(ibas.emMessageType.WARNING, ibas.i18n.prop("receiptpayment_please_choose_paid_method"));
                    return;
                }
