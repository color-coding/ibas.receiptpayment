...
namespace receiptpayment {
    export namespace app {
        ...
        /** 单据付款服务 */
        export class PaymentService extends ibas.ServiceApplication<IPaymentServiceView, businesspartner.app.IPaymentContract[]> {
            /** 应用标识 */
            ...
            protected workDatas: ibas.IList<businesspartner.app.IPaymentContract>;
            /** 运行服务 */
            runService(contracts: businesspartner.app.IPaymentContract[]): void {
                this.workDatas = new ibas.ArrayList<businesspartner.app.IPaymentContract>();
