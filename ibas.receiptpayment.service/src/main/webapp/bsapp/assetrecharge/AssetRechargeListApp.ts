...
namespace receiptpayment {
    export namespace app {
        /** 列表应用-资产充值 */
        export class AssetRechargeListApp extends ibas.BOListApplication<IAssetRechargeListView, bo.AssetRecharge> {

            /** 应用标识 */
            static APPLICATION_ID: string = "4f9d11c9-549c-4831-8dd4-b700f8c7af3e";
            /** 应用名称 */
            static APPLICATION_NAME: string = "receiptpayment_app_assetrecharge_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.AssetRecharge.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = AssetRechargeListApp.APPLICATION_ID;
                this.name = AssetRechargeListApp.APPLICATION_NAME;
                this.boCode = AssetRechargeListApp.BUSINESS_OBJECT_CODE;
            ...
            protected viewData(data: bo.AssetRecharge): void {
                ...
                let app: AssetRechargeViewApp = new AssetRechargeViewApp();
                app.navigation = this.navigation;
                app.viewShower = this.viewShower;
                app.run(data);
            ...
            protected deleteData(data: bo.AssetRecharge | bo.AssetRecharge[]): void {
                let beDeleteds: ibas.IList<bo.AssetRecharge> = ibas.arrays.create(data);
                // 没有选择删除的对象
